...
<body>
    <div class="container centralizador">
        <div>
            <div>
                <img src="./icones/LOGO.PNG" alt="" height="150px" width="350px">
            </div>
            <br>
            <form action="" class="form-grup">
                ...
                <div class="d-flex justify-content-center">
                    <button type="button" class="btn btn-success radio">Entrar</button>
                    <button type="button" class="btn btn-danger radio">Suport</button>
                </div>
            </form>
        </div>
    </div>
